import { RoadmapData, Course } from './types'; // Pastikan 'Course' di-impor

// Ini adalah data simulasi. Dalam aplikasi nyata, ini akan datang dari database SQL Anda.
...
export function getRoadmapData(): RoadmapData {
  // Mengembalikan data simulasi
  return MOCK_ROADMAP_DATA;
}

export function getCourseById(id: number): Course | undefined {
  // Cari di semua semester dan semua mata kuliah
  ...
  // Kembalikan undefined jika tidak ditemukan
  return undefined;
}